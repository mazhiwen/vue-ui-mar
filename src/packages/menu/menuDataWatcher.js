...
menuDataController.prototype.setActive = function(currentIndex,force){
  ...
  let lastActiveIndex = this.parseIndex(this.lastActiveIndex);
...
menuDataController.prototype.sendItemClick = function({index,item,value}) {
...
menuDataController.prototype.setMenuTreeActiveStatus = function(index, status) {
  ...
  let traverseArr = index.toString().split("-");
  let prefixData;
